    ...
    <Box sx={{ display: 'flex', flexDirection: 'column', gap: 2 }}>
      <Card sx={{ borderRadius: 2, boxShadow: 'none', bgcolor: '#fff' }}>
        <CardContent sx={{ p: 2.5 }}>
          <Typography display={'flex'} fontSize={15} fontWeight={700} mb={1}>
            Giảm giá
          </Typography>
          ...
          {/* Bỏ phần hiển thị couponMessage text cũ */}
        </CardContent>
      </Card>

      <Card sx={{ borderRadius: 2, boxShadow: 'none', bgcolor: '#fff' }}>
        <CardContent sx={{ p: 2.5 }}>
          <Typography display={'flex'} fontSize={15} fontWeight={700}>
            Tạm tính
          </Typography>
...
const SummaryRow = ({
  ...
  >
    <Typography fontSize={13} color="text.primary" fontWeight={700}>
      {label}
    </Typography>
    <Typography fontSize={13} fontWeight={bold ? 700 : 500}>
      {value}
    </Typography>
  </Box>
);
